...
**Note:** `sdd-*`, `_shared`, and `skill-registry` skills are excluded from this index as they are SDD infrastructure. They are available at `~/.config/opencode/skills/` and loaded by the orchestrator as needed.
